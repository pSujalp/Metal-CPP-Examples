...
void Renderer::CreateSkyBox()
{
    ...
    skyboxTexture1 = new CubeTexture(facePaths, _pDevice);
    ...
    samplerState = _pDevice->newSamplerState(samplerDescriptor);
    samplerDescriptor->release();

    SamplerBuffer = _pDevice->newBuffer(sizeof(MVP), MTL::ResourceStorageModeShared);
...
void Renderer::draw(MTK::View *pView)
{
    ...
    pEnc->setFragmentTexture(skyboxTexture1->texture, 0);
